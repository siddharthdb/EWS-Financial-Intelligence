...
| 2.8 | Expand priority signal contracts P10–P34 implementations | DONE (partial — P18 REQUIRED_MONITORING_INFORMATION_DELAY and now P12 LEVERAGE_DERIORATION (`total_liabilities_to_equity` + a materially-worsening relative-increase policy); every other P10–P34 contract still needs additional XBRL concepts (income-statement, cash-flow, EBITDA) this platform doesn't parse yet) | 2026-09-25 — total_liabilities_to_equity + LEVERAGE_DERIORATION (P12) |
