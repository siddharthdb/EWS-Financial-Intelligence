...
These four are Phase-2/3-scoped per `docs/architecture/06-gap-analysis-and-implementation-roadmap.md`
Section 7 and are intentionally not written yet -- they govern capabilities (graph intelligence,
model governance) not present in the Phase-1 skeleton, or (ADR-007) depend on ADR-006's gateway
